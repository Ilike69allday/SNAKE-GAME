...
class Snake:
    ...
    def update(self):
        global apple, score, powerup, clock, snakeslowdown, slowdownstart, eatpower_time
...
powerup_spawn_time = 30000  # a new poer up will spawn in every 30 seconds
...
while True:
    ...
    if pygame.time.get_ticks() - spawn_time >10000: #The powerup only appear on screen for 10 second and it will disappeared
        powerup = None
    ...
    if powerup and snake.head.colliderect(powerup.rect):
        ...
        snake_update_frequency = 4  #slow down the speed of snake by changing clock.tick
